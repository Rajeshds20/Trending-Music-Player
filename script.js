...
const basepath = "{{ site.baseurl }}/songs/";
...
const songdetails = {
    ...
    "Ranjithame.mp3": {
        ...
        movie: "Varisu",
        image:
            "https://secureservercdn.net/160.153.138.217/ljp.b8e.myftpupload.com/wp-content/uploads/2022/11/Ranjithame-song-Varisu.jpg?time=1667655733"
    },
    ...
    "Khairiyat.mp3": {
        ...
        movie: "Chhichhore",
        image:
            "https://www.lyricszaade.com/wp-content/uploads/2020/07/khairiyat-chhichhore.jpg"
    },
...
next.addEventListener("click", () => {
    ...
    index++;
    console.log(songlist[(index = index % songlist.length)]);
